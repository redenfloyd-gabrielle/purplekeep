...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2018 at 04:28 PM
...
(1, '2018-03-19 00:00:00', '2018-04-19 00:00:00', 150, 0, 0, 'Approved', 'SoftEng Presentation', 'Our final presentation', 'Conference', 'LB 466 Bunzel', 1, '', NULL, 3, 0, 0, 0, '2018-03-19 23:12:41', '2018-03-19 23:13:17', 19);
...
INSERT INTO `review` (`review_id`, `rating`, `description`, `user_id`, `event_id`) VALUES
(1, 5, 'Nice', 3, 1),
(2, 2, 'Meh', 3, 1);
...
(1, 'Bronze', 50, 50, 1, 0, 0, '2018-03-19 23:12:41', '2018-03-19 23:12:41'),
(2, 'Silver', 100, 50, 1, 0, 0, '2018-03-19 23:12:41', '2018-03-19 23:12:41'),
(3, 'Gold', 200, 50, 1, 0, 0, '2018-03-19 23:12:42', '2018-03-19 23:12:42');
...
(3, 'crystal', '9bc35193ee927e4047ce28012e893ed2366852adede6f7699f6d92b4496deaa5fde1b90143aca4bbee8416d522fb88468e570514be07139f07f94a8c39a335c1', 'Regular', 0, 'Active', 'Crystal', 'Lovegood', 'G', '', 'crystal@gmail.com', '1996-11-07', 'Male', '09567815989', 1000, NULL, NULL, '2018-02-21 20:27:32', '2018-03-06 23:14:56');
...
ALTER TABLE `review`
  ...
  ADD KEY `review_fk1` (`user_id`),
  ADD KEY `review_fk2` (`event_id`);
...
--
ALTER TABLE `review`
  ADD CONSTRAINT `review_fk1` FOREIGN KEY (`user_id`) REFERENCES `user_account` (`account_id`),
  ADD CONSTRAINT `review_fk2` FOREIGN KEY (`event_id`) REFERENCES `event_info` (`event_id`);
