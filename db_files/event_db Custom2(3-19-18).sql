...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2018 at 04:00 PM
...
INSERT INTO `cart` (`cart_id`, `ticket_id`, `quantity`, `total_price`, `account_id`, `status`, `checkoutID`) VALUES
(1, 9, 2, 400, 3, '', 1),
(2, 9, 2, 400, 3, '', 1),
(3, 7, 1, 50, 3, '', 4),
(4, 7, 1, 50, 3, '', 4),
...
INSERT INTO `checkout` (`checkId`, `account_id`, `checkCreatedOn`, `checkTotal`) VALUES
(1, 3, '2018-03-19 14:13:45', '450.00'),
(2, 3, '2018-03-19 14:21:58', '50.00'),
(3, 3, '2018-03-19 14:45:41', '100.00'),
(4, 3, '2018-03-19 14:46:53', '50.00');
...
CREATE TABLE `event_info` (
  ...
  `venue_capacity` int(8) NOT NULL DEFAULT '0',
  `addedBy` int(11) NOT NULL,
  `updatedBy` int(11) NOT NULL,
  `addedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `event_info` (`event_id`, `event_date_start`, `event_date_end`, `no_tickets_total`, `total_no_addedTickets`, `total_tickets_amtSold`, `event_status`, `event_name`, `event_details`, `event_category`, `event_venue`, `event_isActive`, `event_picture`, `color`, `user_id`, `venue_capacity`, `addedBy`, `updatedBy`, `addedAt`, `updatedAt`, `location_id`) VALUES
(1, '2018-03-14 00:00:00', '2018-03-16 00:00:00', 150, 0, 0, 'Approved', 'Same Same', 'fkjewlkfjwelrkew', 'Attraction', 'Same', 1, '', NULL, 3, 0, 0, 0, '2018-03-14 16:05:21', '2018-03-15 00:02:29', 25),
(2, '2018-03-17 00:00:00', '2018-04-17 00:00:00', 150, 0, 0, 'Rejected', 'Same Same', 'I like same', 'Attraction', 'same', 1, '', NULL, 3, 0, 0, 0, '2018-03-17 15:03:03', '2018-03-18 00:10:05', 1),
(3, '2018-03-18 00:00:00', '2018-04-18 00:00:00', 150, 0, 0, 'Approved', 'Same Same', 'I like same', 'Attraction', 'Same', 1, '', NULL, 3, 0, 0, 0, '2018-03-18 00:09:22', '2018-03-18 00:10:09', 1);
...
INSERT INTO `review` (`review_id`, `rating`, `description`, `user_id`) VALUES
(1, 3, 'It was alright', 0),
(2, 3, 'Oks', 0),
(3, 4, 'kjlkjlkj', 0),
(4, 3, 'dasfsdf', 0),
(5, 3, 'Ayy', 0),
...
(1, 'Bronze', 50, 50, 1, 0, 0, '2018-03-14 23:05:21', '2018-03-14 23:05:21'),
(2, 'Bronze', 50, 50, 1, 0, 0, '2018-03-14 23:05:21', '2018-03-15 00:02:29'),
(3, 'Bronze', 50, 50, 1, 0, 0, '2018-03-14 23:05:21', '2018-03-15 00:02:29'),
(4, 'Bronze', 50, 50, 2, 0, 0, '2018-03-17 22:03:04', '2018-03-17 22:03:04'),
(5, 'Silver', 100, 50, 2, 0, 0, '2018-03-17 22:03:04', '2018-03-17 22:03:04'),
(6, 'Gold', 200, 50, 2, 0, 0, '2018-03-17 22:03:04', '2018-03-17 22:03:04'),
(7, 'Bronze', 50, 45, 3, 0, 0, '2018-03-18 00:09:22', '2018-03-19 22:46:53'),
(8, 'Silver', 100, 50, 3, 0, 0, '2018-03-18 00:09:22', '2018-03-18 00:09:22'),
(9, 'Gold', 200, 48, 3, 0, 0, '2018-03-18 00:09:22', '2018-03-19 22:13:45');
...
(3, 'crystal', '9bc35193ee927e4047ce28012e893ed2366852adede6f7699f6d92b4496deaa5fde1b90143aca4bbee8416d522fb88468e570514be07139f07f94a8c39a335c1', 'Regular', 0, 'Active', 'Crystal', 'Lovegood', 'G', '', 'crystal@gmail.com', '1996-11-07', 'Male', '09567815989', 350, NULL, NULL, '2018-02-21 20:27:32', '2018-03-19 22:46:53');
...
(32, '2018-03-14 16:08:32', 3, NULL, 0, 0, '2018-03-15 00:08:32', '2018-03-15 00:08:32'),
(37, '2018-03-19 13:26:57', 3, 3, 0, 0, '2018-03-19 21:26:57', '2018-03-19 21:26:57');
...
--
ALTER TABLE `checkout`
  MODIFY `checkId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `ticket_type`
  MODIFY `ticket_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `user_event_preference`
  MODIFY `user_event_preference_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
