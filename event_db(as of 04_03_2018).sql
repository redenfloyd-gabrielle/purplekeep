...
CREATE TABLE `checkout` (
  ...
  `account_id` int(11) NOT NULL,
  `checkCreatedOn` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(18, 3, '2018-03-04 09:28:29', '2500.00');
...
(1, 'Gold', 500, 5, 1, 0, 0, '2018-02-21 21:37:05', '2018-03-04 13:37:52'),
(2, 'Gold', 500, 75, 2, 0, 0, '2018-02-21 21:40:51', '2018-02-21 21:40:51'),
(3, 'ff', 23, 23, 3, 0, 0, '2018-03-04 17:01:59', '2018-03-04 17:01:59');
...
--
ALTER TABLE `checkout`
  MODIFY `checkId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
